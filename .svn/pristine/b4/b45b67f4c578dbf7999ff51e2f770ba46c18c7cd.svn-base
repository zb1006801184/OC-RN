...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        UIView *contentV = [[UIView alloc] initWithFrame:CGRectMake(30, screenHeight, screenWith - 60, 220)];
        contentV.backgroundColor = [UIColor whiteColor];
        [self addSubview:contentV];
        self.contentV = contentV;
        
        self.pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, 40,contentV.frame.size.width, 180)];
        ...
        //盛放按钮的View
        UIView *upVeiw = [[UIView alloc]initWithFrame:CGRectMake(0, 0, contentV.frame.size.width, 40)];
        upVeiw.backgroundColor = [UIColor whiteColor];
        [contentV addSubview:upVeiw];
        //左边的取消按钮
        cancelButton = [UIButton buttonWithType:UIButtonTypeCustom];
        cancelButton.frame = CGRectMake(12, 0, 40, 40);
        [cancelButton setImage:[UIImage imageNamed:@"mendian_cuo"] forState:UIControlStateNormal];
        ...
        chooseButton.frame = CGRectMake(contentV.frame.size.width - 52, 0, 40, 40);
        [chooseButton setImage:[UIImage imageNamed:@"mendian_dui"] forState:UIControlStateNormal];
        ...
        //分割线
        UIView *splitView = [[UIView alloc] initWithFrame:CGRectMake(0, 40, contentV.frame.size.width, 0.5)];
...
- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component {
    if (self.pickerViewMode == DatePickerViewDateTimeMode) {
        return (_contentV.frame.size.width-40)/5;
    }else if (self.pickerViewMode == DatePickerViewDateMode){
        return (_contentV.frame.size.width-40)/3;
    }else if (self.pickerViewMode == DatePickerViewTimeMode){
        return (_contentV.frame.size.width-40)/2;
    }
    return 0;
}
...
- (void)showDateTimePickerView{
    ...
    [UIView animateWithDuration:0.25f animations:^{
        self.alpha = 1;
        _contentV.frame = CGRectMake(30, 150, screenWith - 60, 220);
...
- (void)hideDateTimePickerView{
    ...
    [UIView animateWithDuration:0.2f animations:^{
        self.alpha = 0;
        _contentV.frame = CGRectMake(30, screenHeight, screenWith - 60, 220);
    } completion:^(BOOL finished) {
