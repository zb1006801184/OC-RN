...
- (void)viewDidLoad {
    ...
    [self setNavBarWithTitle:@"扫描会员卡" isBack:YES];
    UIView *navView = [[UIView alloc]initWithFrame:CGRectMake(0, -20, SCREEN_WIDTH, 20)];
    navView.backgroundColor = [UIColor whiteColor];
    [self.navBarView addSubview:navView];
    [self setNAVRight];
...
- (void)setNAVRight
{
    UIButton *rightButton = [JQXCustom creatButton:CGRectMake(SCREEN_WIDTH - 90, 0, 80, 44) backColor:[UIColor clearColor] text:@" 手机号" textColor:[UIColor whiteColor] font:[UIFont systemFontOfSize:14] addTarget:self Action:@selector(PhoneAction)];
    [rightButton setImage:[UIImage imageNamed:@"icon-phone"] forState:UIControlStateNormal];
