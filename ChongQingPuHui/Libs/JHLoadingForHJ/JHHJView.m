...
- (CALayer *)lineAnimation{
    ...
    shape.fillColor               = BACKGROUNGCOLOR.CGColor;
...
+ (CALayer *)qurareAnimation{
    ...
    shape.fillColor                     = [UIColor colorWithRed:0.06f green:0.75f blue:0.64f alpha:1.00f].CGColor;
...
+ (CALayer *)triangleAnimation{
    ...
    shape.frame                        = CGRectMake(0, 0, radius, radius);
    shape.path                         = [UIBezierPath bezierPathWithOvalInRect:CGRectMake(0, 0, radius, radius)].CGPath;
    shape.strokeColor                  = BACKGROUNGCOLOR.CGColor;
    shape.fillColor                    = BACKGROUNGCOLOR.CGColor;
    shape.lineWidth                    = 1;
...
+ (CALayer *)clipAnimation{
    ...
    bottomShape.fillColor     = [UIColor colorWithRed:0.06f green:0.75f blue:0.64f alpha:1.00f].CGColor;
